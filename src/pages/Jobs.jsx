...
const Jobs = () => {
  ...
  return (
    <Suspense
      fallback={
        <Spin
          className="min-h-[85vh] rounded-lg w-full flex items-center justify-center bg-white"
          indicator={
            <LoadingOutlined style={{ fontSize: 64, color: "#268D61" }} spin />
          }
        />
      }
    >
